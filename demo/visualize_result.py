...
from predictor import FeatureExtractionDemo, FeatureExtractionLATex
...
if __name__ == '__main__':
    ...
    demo = FeatureExtractionLATex(cfg, parallel=False)
    ...
    for (feat, pid, camid) in demo.run_on_loader(test_loader):
        feats.append(feat)
        pids.extend(pid)
        camids.extend(camid)
