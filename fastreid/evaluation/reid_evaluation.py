...
from fastreid.data.datasets.agreidv1 import AG_ReID_v1_AG,AG_ReID_v1_GA
...
class ReidEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        # image = inputs['images'].permute(0,2,3,1).to(self._cpu_device)
        prediction = {
    ...
    def evaluate(self):
        ...
        for prediction in predictions:
            ...
            paths.extend(prediction['img_paths'])
